...
import testingLibraryOverview from '../../../assets/testing-library.png';

<Image src={testingLibraryOverview} alt="Testing Library Usage" />
...
1. Our first requirement is that the component render an author name.
    ...
    Let's try the bare-minimum to get the test to pass. We'll hard-code the author name. 😱
