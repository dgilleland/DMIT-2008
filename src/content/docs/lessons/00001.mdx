...
- **Intro to React and JS**
  - [001](#bs-/001-nextjs-intro-START.zip)
  - [002](#bs-/002-nextjs-intro-COMPLETE.zip)
  - [003](#bs-/003-nextjs-components-intro-START.zip)
  - [004](#bs-/004-nextjs-components-intro-COMPLETE.zip)
  - [005](#bs-/005-nextjs-component-lists-START.zip)
  - [006](#bs-/006-nextjs-component-lists-COMPLETE.zip)
  - [007](#bs-/007-nextjs-bootstrap-component-library-START.zip)
  - [008](#bs-/008-nextjs-bootstrap-component-library-COMPLETE.zip)
  - [009](#bs-/009-nextjs-mui-component-library-START.zip)
  - [010](#bs-/010-nextjs-mui-component-library-COMPLETE.zip)
- **JavaScript Component Libraries and Styling**
  - [011](#bs-/011-nextjs-mui-theming-START.zip)
  - [012](#bs-/012-nextjs-mui-theming-COMPLETE.zip)
  - [013](#bs-/013-nextjs-sass-modules-START.zip)
  - [014](#bs-/014-nextjs-sass-modules-COMPLETE.zip)
- **JavaScript Framework Details: State, Events, and Templating**
  - *Intro to React*
    - [015](#bs-/015-nextjs-event-state-fundamentals-START.zip)
    - [016](#bs-/016-nextjs-event-state-fundamentals-COMPLETE.zip)
    - [017](#bs-/017-nextjs-event-state-jsx-conditionals-START.zip)
    - [018](#bs-/018-nextjs-event-state-jsx-conditionals-COMPLETE.zip)
  - *React State with REST APIs*
    - [019](#bs-/019-react-rest-reviews-app-START.zip)
    - [020](#bs-/020-react-rest-reviews-app-COMPLETE.zip)
    - [021](#bs-/021-react-rest-reviews-app-COMPLETE-DAY-2.zip)
    - [022](#bs-/022-react-rest-reviews-app-COMPLETE-DAY-3.zip)
    - [023](#bs-/023-react-rest-fundamentals-START.zip)
    - [024](#bs-/024-react-rest-fundamentals-COMPLETE.zip)
- **Development to Production Workflow**
  - [025](#bs-/025-vercel-github-deployment-example-START%20(1).zip)
- **React Components and Lifecycle**
  - [026](#bs-/026-reviews-app-with-lifecycle-START.zip)
  - [027](#bs-/027-reviews-app-with-lifecycle-COMPLETE.zip)
  - [028](#bs-/028-react-mounting-fundamentals-START.zip)
  - [029](#bs-/029-react-mounting-fundamentals-COMPLETE.zip)
- **Next.js Pages, Routing and React**
  - [030](#bs-/030-nextjs-pages-and-space-START.zip)
  - [031](#bs-/031-nextjs-pages-and-space-DAY-2.zip)
  - [032](#bs-/032-nextjs-pages-and-space-COMPLETE.zip)
- **Next.js Frontend Features**
  - [033](#bs-/033-nextjs-12-space-page-ssr-START.zip)
  - [034](#bs-/034-nextjs-12-space-page-ssr-COMPLETE.zip)
  - [035](#bs-/035-nextjs-12-reviews-app-ssr-START.zip)
  - [036](#bs-/036-nextjs-12-reviews-app-ssr-COMPLETE.zip)
- **Testing React Next.js Applications**
  - [037](#bs-/037-next-js-testing-example-START.zip)
  - [038](#bs-/038-next-js-testing-example-COMPLETE.zip)
  - [039](#bs-/039-next-js-testing-with-mocking-fetch-START.zip)
  - [040](#bs-/040-next-js-testing-with-mocking-fetch-COMPLETE.zip)
- **Application State with React**
  - [041](#bs-/041-rest-reviews-with-context-toast-START%20(1).zip)
  - [042](#bs-/042-rest-reviews-with-context-toast-COMPLETE.zip)
  - [043](#bs-/043-authentication-example-START.zip)
  - [044](#bs-/044-authentication-example-DAY-1.zip)
  - [045](#bs-/045-authentication-example-complete.zip)
- **Extra Topics**
