...
<Tabs>
  ...
  Your classes are on **Wednesday** and **Thursday** (online). As students in the *Web Design and Development* career path, the material you covered in CPSC-1520 is critical for success in the DMIT-2008 course. Check out the `Agenda.md` file in Dan's Instructor Workbook:
